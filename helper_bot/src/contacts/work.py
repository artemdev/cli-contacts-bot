...
from helper_bot.src.ui.ContactsUserInterface import ContactsUserInterface
...
def show(contact_book: AddressBook):
    ...
    contacts_ui = ContactsUserInterface()

    if res == []:
        contacts_ui.not_found()
        return None
    contacts_ui.show_all(res2)
...
def edit_email(contact_book: AddressBook):
    ...
    contacts_ui.contact_not_found(name)
