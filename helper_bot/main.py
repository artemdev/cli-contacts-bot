...
from helper_bot.src.ui.HelpUserInterface import HelpUserInterface


def help_func():
    help_ui = HelpUserInterface()
    help_ui.show_all()
...
def main():
    contact_book = start()
    commands = list(address_book_commands_list.keys()) + \
        list(general_commands_list.keys()) + list(SHUTDOWN_COMMANDS)
